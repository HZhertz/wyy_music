        ...
        <div class="cover">
          ...
          <div class="cover-info">
            <div class="cover-header">
              ...
              <div class="cover-collect-author">
                <router-link
                  ...
                  :to="{ path: '/artist/detail', query: { id: item.userId } }"
            ...
            <div class="cover-desc">
              <h5>
                歌单简介<em class="desc-close" v-if="isShowDesc" @click="isShowDesc = false"
        ...
        <div class="song-main">
          ...
          <template v-else>
            <SongList
              ...
              :isShowPag="isLogin"
            />
            <!-- <SongList v-else :songList="songList" :stripe="true" /> -->
...
const { details, isShowDesc, songList, page, size, collects, playlists, comments, total, isLoading } =
  toRefs(info)
