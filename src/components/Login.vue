      ...
      <div class="login-wrapper">
        ...
        <el-form ref="loginFormRef" :model="loginForm" :rules="loginFormRules" label-width="">
          <el-form-item prop="phone" label-width="">
            <el-input v-model="loginForm.phone" placeholder="请输入网易云帐号登录"> </el-input>
          </el-form-item>
...
const handleClose = () => store.commit('SET_LOGINDIALOG', false)
...
const getUserInfo = async (uid) => {
  ...
  if (res.code !== 200) {
    ...
    store.commit('SET_USERINFO', res.profile)
  }
}
</script>
